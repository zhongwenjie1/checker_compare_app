# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/multi/test_reindex.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_reindex_limit_arg_with_multiindex",
    "test_reindex_with_none_in_nested_multiindex"
  ]
}
