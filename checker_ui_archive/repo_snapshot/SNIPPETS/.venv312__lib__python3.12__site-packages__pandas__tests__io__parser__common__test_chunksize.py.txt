# .venv312/lib/python3.12/site-packages/pandas/tests/io/parser/common/test_chunksize.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_chunksize_with_usecols_second_block_shorter",
    "test_chunksize_second_block_shorter"
  ]
}
