# .venv312/lib/python3.12/site-packages/pandas/tests/extension/base/reduce.py

## Classes & Methods
{
  "classes": [
    {
      "name": "BaseReduceTests",
      "methods": [
        "_supports_reduction",
        "check_reduce",
        "_get_expected_reduction_dtype",
        "check_reduce_frame",
    ...
    {
      "name": "BaseNoReduceTests",
      "methods": []
    },
    {
      "name": "BaseNumericReduceTests",
      "methods": [
        "_supports_reduction"
      ]
    },
    {
      "name": "BaseBooleanReduceTests",
      "methods": [
        "_supports_reduction"
      ]
    }
