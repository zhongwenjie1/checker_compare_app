# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_set_axis.py

## Classes & Methods
{
  "classes": [
    {
      "name": "SharedSetAxisTests",
      "methods": [
        "obj",
        "test_set_axis",
        "test_set_axis_copy",
        ...
        "test_set_axis_setattr_index_not_collection",
        "test_set_axis_setattr_index_wrong_length"
      ]
    },
    {
      "name": "TestDataFrameSetAxis",
      "methods": [
        "obj"
      ]
    },
    {
      "name": "TestSeriesSetAxis",
      "methods": [
        "obj"
      ]
    }
