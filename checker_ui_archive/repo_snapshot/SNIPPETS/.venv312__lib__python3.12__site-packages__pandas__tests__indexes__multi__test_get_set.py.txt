# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/multi/test_get_set.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_get_dtypes_duplicate_level_names",
    ...
    "test_set_empty_level",
    "test_set_levels_pos_args_removal",
    "test_set_levels_categorical_keep_dtype"
  ]
}
...
def test_set_empty_level():
    ...
    result = midx.set_levels(pd.DatetimeIndex([
```
