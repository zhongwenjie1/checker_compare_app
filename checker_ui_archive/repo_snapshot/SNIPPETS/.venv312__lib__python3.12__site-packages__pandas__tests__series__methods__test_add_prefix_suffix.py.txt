# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_add_prefix_suffix.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_add_prefix_suffix_axis",
    "test_add_prefix_suffix_invalid_axis"
  ]
}
