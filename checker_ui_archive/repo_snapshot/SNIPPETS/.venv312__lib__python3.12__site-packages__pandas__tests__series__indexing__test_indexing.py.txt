# .venv312/lib/python3.12/site-packages/pandas/tests/series/indexing/test_indexing.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDeprecatedIndexers",
      "methods": [
        "test_getitem_dict_and_set_deprecated",
        "test_getitem_dict_and_set_deprecated_multiindex",
        "test_setitem_dict_and_set_disallowed",
        "test_setitem_dict_and_set_disallowed_multiindex"
      ]
    },
    {
      "name": "TestSetitemValidation",
      "methods": [
  ...
  "functions": [
    "test_basic_indexing",
    "test_getitem_numeric_should_not_fallback_to_positional",
    "test_setitem_numeric_should_not_fallback_to_positional",
    ...
    "test_loc_setitem_all_false_indexer",
    "test_loc_boolean_indexer_non_matching_index",
    "test_loc_boolean_indexer_miss_matching_index",
    "test_loc_setitem_nested_data_enlargement",
    "test_loc_ea_numeric_index_oob_slice_end",
    "test_getitem_bool_int_key",
    "test_setitem_empty_indexer"
  ]
}
