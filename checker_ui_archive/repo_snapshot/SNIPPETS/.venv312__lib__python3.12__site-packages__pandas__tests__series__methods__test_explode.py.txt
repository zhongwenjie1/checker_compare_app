# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_explode.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_explode_pyarrow_list_type",
    "test_explode_pyarrow_non_list_type",
    "test_str_dtype"
  ]
}
