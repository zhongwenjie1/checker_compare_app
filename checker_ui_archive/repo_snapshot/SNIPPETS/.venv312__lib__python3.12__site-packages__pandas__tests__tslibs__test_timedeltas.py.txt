# .venv312/lib/python3.12/site-packages/pandas/tests/tslibs/test_timedeltas.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestArrayToTimedelta64",
      "methods": [
        "test_array_to_timedelta64_string_with_unit_2d_raises",
        "test_array_to_timedelta64_non_object_raises"
      ]
    }
  ],
  "functions": [
    ...
    "test_delta_to_nanoseconds_td64_MY_raises",
    "test_unsupported_td64_unit_raises",
    "test_huge_nanoseconds_overflow",
    "test_kwarg_assertion",
    "test_ints_to_pytimedelta",
    "test_ints_to_pytimedelta_unsupported"
  ]
}
