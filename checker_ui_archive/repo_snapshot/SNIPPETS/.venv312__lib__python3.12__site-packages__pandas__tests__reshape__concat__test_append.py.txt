# .venv312/lib/python3.12/site-packages/pandas/tests/reshape/concat/test_append.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_append_empty_tz_frame_with_datetime64ns",
        "test_append_empty_frame_with_timedelta64ns_nat",
        "test_append_frame_with_timedelta64ns_nat"
      ]
    }
  ],
  "functions": []
...
class TestAppend:
    ...
    def test_append_empty_tz_frame_with_datetime64ns(self, using_array_manager):
        ...
        if using_array_manager:
            expected = DataFrame({"a": [pd.NaT]}, dty
```
