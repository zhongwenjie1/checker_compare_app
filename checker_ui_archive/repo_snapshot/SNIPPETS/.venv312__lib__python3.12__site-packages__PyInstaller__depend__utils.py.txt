# .venv312/lib/python3.12/site-packages/PyInstaller/depend/utils.py

## Classes & Methods
{
  "classes": [],
  "functions": [
    "create_py3_base_library",
    "scan_code_for_ctypes",
    "__recursively_scan_code_objects_for_ctypes",
    "_scan_code_for_ctypes_getattr",
