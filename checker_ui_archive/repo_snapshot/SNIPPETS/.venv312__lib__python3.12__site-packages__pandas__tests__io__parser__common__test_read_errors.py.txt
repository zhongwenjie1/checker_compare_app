# .venv312/lib/python3.12/site-packages/pandas/tests/io/parser/common/test_read_errors.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_bad_header_uniform_error",
    "test_on_bad_lines_warn_correct_formatting"
  ]
}
