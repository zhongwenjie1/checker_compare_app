# .venv312/lib/python3.12/site-packages/pandas/tests/extension/base/reshaping.py

## Classes & Methods
{
  "classes": [
    {
      "name": "BaseReshapingTests",
      "methods": [
        "test_concat",
...
class BaseReshapingTests:
    ...
    def test_unstack(self, data, index, obj):
        ...
        for level in combinations:
            ...
            expected = obj_ser.unstack(level=level, fill_value=data.dtype.na
```
