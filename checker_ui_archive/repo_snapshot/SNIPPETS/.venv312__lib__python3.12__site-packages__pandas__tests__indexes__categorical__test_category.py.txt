# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/categorical/test_category.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_insert",
        "test_insert_na_mismatched_dtype",
        "test_delete",
        "test_is_monotonic",
        "test_has_duplicates",
        ...
        "test_repr_roundtrip",
        "test_isin",
        "test_isin_overlapping_intervals",
        "test_identical",
        "test_ensure_copied_data"
      ]
    },
    {
      "name": "TestCategoricalIndex2",
      "methods": [
        "test_view_i8",
        "test_engine_type",
...
class TestCategoricalIndex2:
    ...
    def test_disallow_addsub_ops(self, func, op_name):
        ...
        msg = "|".join(
            [
                f"cannot perform {op_name} with thi
```
