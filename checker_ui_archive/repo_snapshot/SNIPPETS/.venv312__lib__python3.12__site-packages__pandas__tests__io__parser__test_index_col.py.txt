# .venv312/lib/python3.12/site-packages/pandas/tests/io/parser/test_index_col.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_infer_types_boolean_sum",
    "test_specify_dtype_for_index_col",
    "test_multiindex_columns_not_leading_index_col"
  ]
}
