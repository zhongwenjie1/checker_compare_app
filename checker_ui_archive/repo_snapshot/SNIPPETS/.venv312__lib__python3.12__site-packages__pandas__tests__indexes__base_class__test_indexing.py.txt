# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/base_class/test_indexing.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestGetSliceBounds",
      "methods": [
        "test_get_slice_bounds_within",
        "test_get_slice_bounds_outside",
        "test_get_slice_bounds_invalid_side"
      ]
    },
    {
  ...
  "functions": [
    "test_getitem_boolean_ea_indexer"
  ]
}
