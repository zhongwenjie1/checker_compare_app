# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_reindex.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_reindex_pad",
    "test_reindex_pad2",
    "test_reindex_inference",
    "test_reindex_downcasting",
