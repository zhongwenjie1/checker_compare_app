# .venv312/lib/python3.12/site-packages/pandas/tests/window/test_cython_aggregations.py

## Classes & Methods
{
  "classes": [],
  "functions": [
    "_get_rolling_aggregations",
    "rolling_aggregation",
    "test_rolling_aggregation_boundary_consistency",
    "test_rolling_aggregation_with_unused_elements"
  ]
}
