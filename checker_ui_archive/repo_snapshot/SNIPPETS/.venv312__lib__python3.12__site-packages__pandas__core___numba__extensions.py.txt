# .venv312/lib/python3.12/site-packages/pandas/core/_numba/extensions.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "type_index_constructor",
    "pdseries_constructor",
    "pdseries_constructor_with_name",
    "index_constructor_2arg",
    "index_constructor_2arg_parent",
    "index_constructor_1arg",
    "maybe_cast_str",
    "maybe_cast_str_impl",
    "unbox_index",
    "unbox_series",
    "box_index",
    "box_series",
    "generate_series_reduction",
    "generate_series_binop",
    "index_get_loc",
    "series_indexing",
    "index_indexing",
    "typeof_iloc",
    "type_iloc_constructor",
    "iloc_constructor",
    "series_iloc",
    "iloc_getitem"
  ]
