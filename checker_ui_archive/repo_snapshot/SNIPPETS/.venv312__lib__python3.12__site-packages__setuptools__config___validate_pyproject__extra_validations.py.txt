# .venv312/lib/python3.12/site-packages/setuptools/config/_validate_pyproject/extra_validations.py

## Classes & Methods
{
  "classes": [
    {
      "name": "RedefiningStaticFieldAsDynamic",
      "methods": []
    },
    {
      "name": "IncludedDependencyGroupMustExist",
      "methods": []
    }
  ],
  "functions": [
