# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_nlargest.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestSeriesNLargestNSmallest",
      "methods": [
        "test_nlargest_error",
        ...
        "test_nlargest_nullable",
        "test_nsmallest_nan_when_keep_is_all"
      ]
    }
  ],
  "functions": [
