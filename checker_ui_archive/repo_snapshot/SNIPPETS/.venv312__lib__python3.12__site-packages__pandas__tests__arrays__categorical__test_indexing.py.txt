# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/categorical/test_indexing.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestCategoricalIndexingWithFactor",
      "methods": [
        "test_getitem",
        "test_setitem",
    ...
    {
      "name": "TestCategoricalIndexing",
      "methods": [
        "test_getitem_slice",
        "test_getitem_listlike",
        "test_periodindex",
        "test_periodindex_on_null_types",
