# .venv312/lib/python3.12/site-packages/numpy/_core/tests/test_longdouble.py
...
## Classes & Methods
{
  "classes": [
    ...
    {
      "name": "TestCommaDecimalPointLocale",
      "methods": [
        "test_str_roundtrip_foreign",
...
def test_musllinux_x86_64_signature():
    ...
    sig = (np.longdouble(-1.0) / np.longd
```
