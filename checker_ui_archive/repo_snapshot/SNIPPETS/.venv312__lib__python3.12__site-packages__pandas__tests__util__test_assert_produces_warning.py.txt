# .venv312/lib/python3.12/site-packages/pandas/tests/util/test_assert_produces_warning.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestFalseOrNoneExpectedWarning",
      "methods": [
        "test_raise_on_warning",
        "test_no_raise_without_warning",
        "test_no_raise_with_false_raise_on_extra"
      ]
    }
  ],
  "functions": [
    ...
    "test_fail_to_match_runtime_warning",
    "test_fail_to_match_future_warning",
    "test_fail_to_match_resource_warning",
    ...
    "test_match_multiple_warnings",
    "test_right_category_wrong_match_raises",
    "test_raises_during_exception",
    "test_passes_during_exception"
  ]
}
