# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_duplicated.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_duplicated_categorical_bool_na",
    "test_duplicated_mask",
    "test_duplicated_mask_no_duplicated_na"
  ]
}
