# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_map.py
...
## Classes & Methods
{
  ...
  "functions": [
    "test_map",
    "test_map_float_object_conversion",
    "test_map_keeps_dtype",
    "test_map_str",
    "test_map_datetimelike",
    "test_map_empty",
    "test_map_kwargs",
    "test_map_na_ignore",
    "test_map_box_timestamps",
    "test_map_box",
    "test_frame_map_dont_convert_datetime64",
    "test_map_function_runs_once",
    "test_map_type",
    "test_map_invalid_na_action",
    "test_applymap_deprecated"
  ]
}
