# .venv312/lib/python3.12/site-packages/pandas/tests/io/parser/test_unsupported.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_pyarrow_engine",
        "test_on_bad_lines_callable_python_or_pyarrow"
      ]
    }
  ],
  "functions": [
    "python_engine",
    "test_close_file_handle_on_invalid_usecols",
    "test_invalid_file_inputs",
