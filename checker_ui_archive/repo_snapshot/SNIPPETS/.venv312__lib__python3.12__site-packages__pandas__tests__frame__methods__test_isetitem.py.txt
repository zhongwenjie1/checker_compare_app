# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_isetitem.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameSetItem",
      "methods": [
        "test_isetitem_ea_df",
        "test_isetitem_ea_df_scalar_indexer",
        "test_isetitem_dimension_mismatch"
      ]
    }
  ],
  "functions": []
