# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_infer_objects.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestInferObjects",
      "methods": [
        "test_copy",
        "test_infer_objects_series",
        "test_infer_objects_interval",
        "test_infer_objects_bytes"
      ]
    }
  ],
  "functions": []
