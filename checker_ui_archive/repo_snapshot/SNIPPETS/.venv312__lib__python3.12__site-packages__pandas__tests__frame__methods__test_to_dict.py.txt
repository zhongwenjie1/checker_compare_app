# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_to_dict.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameToDict",
      "methods": [
        ...
        "test_to_dict_na_to_none",
        "test_to_dict_masked_native_python",
        "test_to_dict_pos_args_deprecation"
      ]
    }
  ],
  "functions": [
    "test_to_dict_list_pd_scalars"
  ]
}
