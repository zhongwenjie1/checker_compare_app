# .venv312/lib/python3.12/site-packages/PyInstaller/utils/hooks/gi.py
...
## Classes & Methods
{
  ...
  "functions": [
    "get_gi_libdir",
    "get_gi_typelibs",
    "gir_library_path_fix",
    "get_glib_system_data_dirs",
    "get_glib_sysconf_dirs",
    "collect_glib_share_files",
    "collect_glib_etc_files",
    "collect_glib_translations",
    "compile_glib_schema_files"
  ]
}
...
def compile_glib_schema_files(datas_toc, workdir, collect_source_files=False):
    """
    Compile collected GLib schema files. Extracts the list of
```
