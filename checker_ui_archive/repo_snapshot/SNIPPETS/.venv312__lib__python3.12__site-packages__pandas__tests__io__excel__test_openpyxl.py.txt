# .venv312/lib/python3.12/site-packages/pandas/tests/io/excel/test_openpyxl.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_book_and_sheets_consistent",
    "test_ints_spelled_with_decimals",
    "test_read_multiindex_header_no_index_names"
  ]
}
