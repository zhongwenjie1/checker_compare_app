# .venv312/lib/python3.12/site-packages/setuptools/tests/config/test_pyprojecttoml_dynamic_deps.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_dynamic_optional_dependencies",
    "test_mixed_dynamic_optional_dependencies",
