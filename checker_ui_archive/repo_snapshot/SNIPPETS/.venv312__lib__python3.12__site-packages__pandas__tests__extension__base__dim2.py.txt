# .venv312/lib/python3.12/site-packages/pandas/tests/extension/base/dim2.py

## Classes & Methods
{
  "classes": [
    {
      "name": "Dim2CompatTests",
      "methods": [
        "skip_if_doesnt_support_2d",
        "test_transpose",
        "test_frame_from_2d_array",
        "test_swapaxes",
        "test_delete_2d",
        "test_take_2d",
        "test_repr_2d",
        ...
        "test_tolist_2d",
        "test_concat_2d",
        "test_fillna_2d_method",
        "test_reductions_2d_axis_none",
        "test_reductions_2d_axis0",
        "test_reductions_2d_axis1"
      ]
    },
    {
      "name": "NDArrayBacked2DTests",
      "methods": [
        "test_copy_order"
      ]
    }
