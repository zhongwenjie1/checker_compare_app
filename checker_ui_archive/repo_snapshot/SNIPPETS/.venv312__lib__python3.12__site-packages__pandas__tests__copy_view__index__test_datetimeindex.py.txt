# .venv312/lib/python3.12/site-packages/pandas/tests/copy_view/index/test_datetimeindex.py
...
## Classes & Methods
{
  ...
  "functions": [
    "test_datetimeindex",
    "test_datetimeindex_tz_convert",
    "test_datetimeindex_tz_localize",
    "test_datetimeindex_isocalendar",
    "test_index_values"
  ]
}
