# .venv312/lib/python3.12/site-packages/pandas/tests/frame/test_cumulative.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameCumulativeOps",
      "methods": [
        "test_cumulative_ops_smoke",
        "test_cumprod_smoke",
        "test_cumulative_ops_match_series_apply",
        "test_cumsum_preserve_dtypes"
      ]
    }
  ],
  "functions": []
