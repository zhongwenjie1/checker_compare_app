# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/categorical/test_map.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_map_str",
    "test_map",
    "test_map_with_nan_none",
    "test_map_with_nan_ignore",
    "test_map_with_dict_or_series",
    "test_map_na_action_no_default_deprecated"
  ]
}
