# .venv312/lib/python3.12/site-packages/numpy/polynomial/tests/test_symbol.py
...
## Classes & Methods
{
  "classes": [
    ...
    {
      "name": "TestBinaryOperatorsSameSymbol",
      "methods": [
        "test_add",
        "test_sub",
        "test_polymul",
    ...
    {
      "name": "TestBinaryOperatorsDifferentSymbol",
      "methods": [
        "test_binops_fails"
      ]
    },
