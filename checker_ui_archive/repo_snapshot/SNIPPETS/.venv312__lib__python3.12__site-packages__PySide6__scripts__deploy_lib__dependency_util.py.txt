# .venv312/lib/python3.12/site-packages/PySide6/scripts/deploy_lib/dependency_util.py

## Classes & Methods
{
  "classes": [
    {
      "name": "QtDependencyReader",
      "methods": [
        "__init__",
        "get_qt_libs_dir",
        "lib_reader",
        "find_dependencies",
        "find_plugin_dependencies"
      ]
    }
  ],
  "functions": [
        ...
        for line in output.splitlines():
            ...
            if match:
                ...
                if dep_module not in used_modules:
                    ...
                    self.find_dependencies(module=dep_module, used_modules=used
```
