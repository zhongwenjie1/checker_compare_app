# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/datetimes/test_scalar_compat.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDatetimeIndexOps",
      "methods": [
        ...
        "test_dti_nanosecond",
        "test_dti_hour_tzaware",
        "test_day_name_month_name",
        "test_dti_week",
        "test_dti_fields",
        "test_dti_is_year_quarter_start",
        "test_dti_is_month_start",
        "test_dti_is_month_start_custom"
      ]
    }
  ],
  "functions": []
