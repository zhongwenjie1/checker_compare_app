# .venv312/lib/python3.12/site-packages/pandas/tests/frame/test_unary.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameUnaryOperators",
      "methods": [
        "test_neg_numeric",
        "test_neg_object",
        "test_neg_raises",
        "test_invert",
        "test_invert_mixed",
        "test_invert_empty_not_input",
        "test_pos_numeric",
        "test_pos_object",
        "test_pos_object_raises",
        "test_pos_raises",
        "test_unary_nullable"
      ]
    }
