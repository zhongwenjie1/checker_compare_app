# .venv312/lib/python3.12/site-packages/pandas/tests/copy_view/test_clip.py

## Classes & Methods
{
  "classes": [],
  "functions": [
    "test_clip_inplace_reference",
    "test_clip_inplace_reference_no_op",
    "test_clip_inplace",
    "test_clip",
    "test_clip_no_op",
    "test_clip_chained_inplace"
  ]
}
