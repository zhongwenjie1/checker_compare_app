# .venv312/lib/python3.12/site-packages/pandas/tests/test_expressions.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_python_semantics_with_numexpr_installed"
      ]
    }
  ],
  "functions": [
...
class TestExpressions:
    ...
    def test_bool_ops_column_name_dtype(self, test_input, expected):
        # GH 22383 - .ne fails if columns containing column name 'dt
```
