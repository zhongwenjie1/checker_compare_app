# .venv312/lib/python3.12/site-packages/setuptools/tests/test_find_packages.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestFindPackages",
      "methods": [
        "setup_method",
        "teardown_method",
        "_make_pkg_structure",
        ...
        "test_dir_with_packages_in_subdir_is_excluded",
        "test_symlinked_packages_are_included",
        "_assert_packages",
    ...
    {
      "name": "TestFlatLayoutPackageFinder",
      "methods": [
        "test_unwanted_directories_not_included"
      ]
    }
  ],
  "functions": [
