# .venv312/lib/python3.12/site-packages/pandas/tests/extension/base/ops.py
  ...
  "classes": [
    ...
    },
    {
      ...
      "methods": [
        ...
        "test_direct_arith_with_ndframe_returns_not_implemented"
      ]
    },
    {
      "name": "BaseComparisonOpsTests",
      "methods": [
        "_compare_other",
        "test_compare_scalar",
        "test_compare_array"
    ...
    {
      "name": "BaseUnaryOpsTests",
      "methods": [
        "test_invert",
        "test_unary_ufunc_dunder_equivalence"
      ]
    }
  ],
  "functions": []
