# .venv312/lib/python3.12/site-packages/pandas/tests/copy_view/test_chained_assignment_deprecation.py

## Classes & Methods
{
  "classes": [],
  "functions": [
    "test_methods_iloc_warn",
    "test_methods_iloc_getitem_item_cache",
    "test_methods_iloc_getitem_item_cache_fillna",
    "test_series_setitem",
    "test_frame_setitem"
  ]
}
