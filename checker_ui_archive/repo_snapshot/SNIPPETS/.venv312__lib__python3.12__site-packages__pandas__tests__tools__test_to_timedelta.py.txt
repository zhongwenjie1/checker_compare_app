# .venv312/lib/python3.12/site-packages/pandas/tests/tools/test_to_timedelta.py
  ...
  "classes": [
    {
      "name": "TestTimedeltas",
      "methods": [
        "test_to_timedelta_dt64_raises",
        "test_to_timedelta_readonly",
        "test_to_timedelta_null",
        "test_to_timedelta_same_np_timedelta64",
        "test_to_timedelta_series",
        "test_to_timedelta_units",
        "test_to_timedelta_units_dtypes",
        "test_to_timedelta_oob_non_nano",
        "test_to_timedelta_dataframe",
        "test_to_timedelta_invalid_errors",
        "test_to_timedelta_invalid_unit",
        "test_to_timedelta_time",
        "test_to_timedelta_bad_value",
        "test_to_timedelta_bad_value_coerce",
        "test_to_timedelta_invalid_errors_ignore",
        "test_unambiguous_timedelta_values",
        "test_to_timedelta_via_apply",
        "test_to_timedelta_inference_without_warning",
        "test_to_timedelta_on_missing_values",
        "test_to_timedelta_on_missing_values_scalar",
        "test_to_timedelta_on_missing_values_list",
        ...
        "test_to_timedelta_precision_over_nanos",
        "test_to_timedelta_zerodim",
        "test_to_timedelta_numeric_ea",
        "test_to_timedelta_fraction"
      ]
    }
  ],
  "functions": [
    "test_from_numeric_arrow_dtype",
    "test_from_timedelta_arrow_dtype"
  ]
}
...
def test_from_numeric_arrow_dtype(any_numeric_ea_dtype):
    ...
    ser = Series([1, 2], dtype=f"{any_numeric_ea_
```
