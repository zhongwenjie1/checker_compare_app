# .venv312/lib/python3.12/site-packages/pandas/tests/frame/indexing/test_mask.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameMask",
      "methods": [
        "test_mask",
        "test_mask2",
        "test_mask_inplace",
        ...
        "test_mask_callable",
        "test_mask_dtype_bool_conversion"
      ]
    }
  ],
  "functions": [
    ...
    "test_mask_return_dtype",
    "test_mask_inplace_no_other"
  ]
}
