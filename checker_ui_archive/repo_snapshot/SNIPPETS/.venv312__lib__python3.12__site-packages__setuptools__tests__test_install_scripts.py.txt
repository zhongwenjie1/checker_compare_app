# .venv312/lib/python3.12/site-packages/setuptools/tests/test_install_scripts.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestInstallScripts",
      "methods": [
        "_run_install_scripts",
        "test_sys_executable_escaping_unix",
        "test_sys_executable_escaping_win32",
