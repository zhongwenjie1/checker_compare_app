# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/categorical/test_replace.py

## Classes & Methods
{
  "classes": [],
  "functions": [
    "test_replace_categorical_series",
    "test_replace_categorical",
    "test_replace_categorical_ea_dtype",
    "test_replace_maintain_ordering"
  ]
}
