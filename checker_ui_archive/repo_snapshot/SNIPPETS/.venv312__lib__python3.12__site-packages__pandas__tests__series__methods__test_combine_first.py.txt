# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_combine_first.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestCombineFirst",
      "methods": [
        ...
        "test_combine_first_preserves_dtype",
        "test_combine_mixed_timezone"
      ]
    }
  ],
  "functions": []
