# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_value_counts.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestSeriesValueCounts",
      "methods": [
        ...
        "test_value_counts_complex_numbers",
        "test_value_counts_masked"
      ]
    }
  ],
  "functions": []
