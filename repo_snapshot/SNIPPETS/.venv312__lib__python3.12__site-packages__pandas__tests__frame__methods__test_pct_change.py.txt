# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_pct_change.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFramePctChange",
      "methods": [
        "test_pct_change_with_nas",
  ...
  "functions": [
    ...
    "test_pct_change_none_beginning_no_warning"
  ]
}
