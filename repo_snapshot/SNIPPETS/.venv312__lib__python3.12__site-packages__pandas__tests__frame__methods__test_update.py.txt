# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_update.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameUpdate",
      "methods": [
        "test_update_nan",
        "test_update",
        "test_update_dtypes",
        ...
        "test_update_datetime_tz_in_place",
        "test_update_with_different_dtype",
        "test_update_modify_view",
        "test_update_dt_column_with_NaT_create_column"
      ]
    }
  ],
  "functions": []
