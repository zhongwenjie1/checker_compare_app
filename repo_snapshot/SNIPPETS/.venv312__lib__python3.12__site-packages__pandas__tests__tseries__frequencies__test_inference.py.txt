# .venv312/lib/python3.12/site-packages/pandas/tests/tseries/frequencies/test_inference.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_infer_freq_non_nano",
    "test_infer_freq_non_nano_tzaware"
  ]
}
