# .venv312/lib/python3.12/site-packages/pandas/tests/reshape/merge/test_merge_ordered.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestMergeOrdered",
      "methods": [
        "test_basic",
        "test_ffill",
        "test_multigroup",
        ...
        "test_empty_sequence_concat_ok",
        "test_doc_example",
        "test_list_type_by",
        "test_left_by_length_equals_to_right_shape0",
        "test_elements_not_in_by_but_in_df",
        "test_ffill_validate_fill_method",
        "test_ffill_left_merge"
      ]
    }
  ],
  "functions": [
