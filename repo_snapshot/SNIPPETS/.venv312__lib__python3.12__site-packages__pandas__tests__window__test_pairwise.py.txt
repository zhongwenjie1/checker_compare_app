# .venv312/lib/python3.12/site-packages/pandas/tests/window/test_pairwise.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_multindex_columns_pairwise_func"
      ]
    }
  ],
  "functions": [
    ...
    "test_rolling_cov",
    "test_rolling_corr",
    "test_rolling_corr_bias_correction",
