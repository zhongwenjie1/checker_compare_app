# .venv312/lib/python3.12/site-packages/setuptools/tests/test_find_py_modules.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestModuleFinder",
      "methods": [
        "find",
        "test_finder",
    ...
    {
      "name": "TestFlatLayoutModuleFinder",
      "methods": [
        "find",
        "test_unwanted_files_not_included"
      ]
    }
  ],
  "functions": []
