# .venv312/lib/python3.12/site-packages/setuptools/tests/test_core_metadata.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestParityWithMetadataFromPyPaWheel",
      "methods": [
        "base_example",
        "test_requires_dist",
        "dist",
        "test_equivalent_output"
      ]
    },
    {
      "name": "TestPEP643",
      "methods": [
        "test_static_config_has_no_dynamic",
        "test_modified_fields_marked_as_dynamic",
        "test_license_files_dynamic"
      ]
    }
  ],
  "functions": [
    "test_rfc822_unescape",
    "__read_test_cases",
    "test_read_metadata",
    "__maintainer_test_cases",
    "test_maintainer_author",
    "_makedist",
    "_assert_roundtrip_message",
    "_normalize_metadata",
    "_normalize_req",
    "_get_pkginfo",
    "_get_metadata",
