# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/interval/test_interval_range.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestIntervalRange",
      "methods": [
        ...
        "test_float_subtype",
        "test_interval_range_fractional_period",
...
class TestIntervalRange:
    ...
    def test_errors(self):
        ...
        with pytest.raises(TypeError, match=msg):
            interval_range(start=Timedelta("1 day"), end=Timedelta("10 
```
