# .venv312/lib/python3.12/site-packages/pandas/tests/tslibs/test_to_offset.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_to_offset_lowercase_frequency_deprecated",
    "test_to_offset_uppercase_frequency_deprecated"
  ]
}
