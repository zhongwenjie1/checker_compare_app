# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/period/test_formats.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestPeriodIndexRendering",
      "methods": [
        "test_format_empty",
        "test_representation",
