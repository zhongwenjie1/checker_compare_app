# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_filter.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameFilter",
      "methods": [
        "test_filter",
        ...
        "test_filter_keep_order",
        "test_filter_different_dtype"
      ]
    }
  ],
  "functions": []
