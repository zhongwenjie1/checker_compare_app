# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/sparse/test_accessor.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestSeriesAccessor",
      "methods": [
        "test_to_dense",
        "test_get_attributes",
        "test_from_coo",
    ...
    },
    {
      ...
      "methods": [
        ...
        "test_to_coo",
        "test_to_coo_nonzero_fill_val_raises",
        "test_to_coo_midx_categorical",
        "test_to_dense",
        "test_density",
