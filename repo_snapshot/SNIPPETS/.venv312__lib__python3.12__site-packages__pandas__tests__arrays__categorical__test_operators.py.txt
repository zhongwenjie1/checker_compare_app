# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/categorical/test_operators.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestCategoricalOpsWithFactor",
      "methods": [
    ...
    },
    {
      ...
      "methods": [
        ...
        "test_numeric_like_ops_series",
        "test_numeric_like_ops_series_arith",
        "test_numeric_like_ops_series_invalid"
      ]
    }
  ],
  "functions": []
...
class TestCategoricalOps:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            lambda *args, **kwargs: Series(Categorical(*ar
```
