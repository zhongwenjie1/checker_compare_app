# .venv312/lib/python3.12/site-packages/pandas/tests/groupby/test_libgroupby.py

## Classes & Methods
{
  "classes": [
    {
      "name": "GroupVarTestMixin",
      "methods": [
    ...
    {
      "name": "TestGroupVarFloat64",
      "methods": [
        "test_group_var_large_inputs"
      ]
    },
    {
      "name": "TestGroupVarFloat32",
      "methods": []
    }
  ],
  "functions": [
    ...
    "test_cython_group_mean_datetimelike",
    ...
    "test_cython_group_sum_Inf_at_begining_and_end"
  ]
}
