# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/multi/test_get_level_values.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestGetLevelValues",
      "methods": [
  ...
  "functions": [
    ...
    "test_values_loses_freq_of_underlying_index"
  ]
}
