# .venv312/lib/python3.12/site-packages/setuptools/_vendor/typeguard/_config.py

## Classes & Methods
{
  "classes": [
    {
      "name": "ForwardRefPolicy",
      "methods": []
    },
    {
      "name": "CollectionCheckStrategy",
      "methods": [
        "iterate_samples"
      ]
    },
    {
      "name": "TypeCheckConfiguration",
      "methods": []
    }
  ],
  "functions": []
