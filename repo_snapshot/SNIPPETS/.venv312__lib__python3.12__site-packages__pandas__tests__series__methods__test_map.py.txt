# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_map.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_map_callable",
    "test_map_same_length_inference_bug",
    "test_series_map_box_timestamps",
    "test_map_series_stringdtype",
    "test_map_categorical_with_nan_values",
    "test_map_empty_integer_series",
    "test_map_empty_integer_series_with_datetime_index",
    "test_map_simple_str_callables_same_as_astype",
    "test_list_raises",
    "test_map",
    "test_map_datetime",
    "test_map_category",
    "test_map_category_numeric",
    "test_map_category_string",
    "test_map_empty",
    "test_map_compat",
    "test_map_int",
    ...
    "test_map_defaultdict_na_key",
    "test_map_defaultdict_missing_key",
    "test_map_defaultdict_unmutated",
    "test_map_dict_ignore_na",
    "test_map_defaultdict_ignore_na",
    "test_map_categorical_na_ignore",
    ...
    "test_map_scalar_on_date_time_index_aware_series",
    "test_map_float_to_string_precision",
    "test_map_to_timedelta",
    "test_map_type"
  ]
}
