# .venv312/lib/python3.12/site-packages/numpy/_core/tests/test_scalar_methods.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestAsIntegerRatio",
      "methods": [
        "test_small",
    ...
    },
    {
      ...
      "methods": [
        "test_abc",
        "test_abc_complexfloating",
        "test_abc_complexfloating_subscript_tuple",
        "test_abc_non_numeric",
        "test_concrete",
        "test_subscript_tuple",
        "test_subscript_scalar"
      ]
    },
    {
      "name": "TestBitCount",
