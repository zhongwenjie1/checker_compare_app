# .venv312/lib/python3.12/site-packages/pandas/tests/tslibs/test_np_datetime.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestAstypeOverflowSafe",
      "methods": [
        "test_pass_non_dt64_array",
        "test_pass_non_dt64_dtype",
        "test_astype_overflowsafe_dt64",
  ...
  "functions": [
    "test_is_unitless",
    "test_get_unit_from_dtype",
    "test_td64_to_tdstruct"
  ]
}
