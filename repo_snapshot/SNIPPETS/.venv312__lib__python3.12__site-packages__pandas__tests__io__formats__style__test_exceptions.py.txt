# .venv312/lib/python3.12/site-packages/pandas/tests/io/formats/style/test_exceptions.py
...
## Classes & Methods
{
  ...
  "functions": [
    "df",
    "styler",
    "test_concat_bad_columns",
    "test_concat_bad_type",
    "test_concat_bad_index_levels"
  ]
}
