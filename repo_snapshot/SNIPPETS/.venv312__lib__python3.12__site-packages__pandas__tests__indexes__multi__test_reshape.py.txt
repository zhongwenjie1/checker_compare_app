# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/multi/test_reshape.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_append",
    "test_append_index",
    "test_append_names_match",
    "test_append_names_dont_match",
    "test_append_overlapping_interval_levels",
    "test_repeat",
    "test_insert_base",
    "test_delete_base"
  ]
