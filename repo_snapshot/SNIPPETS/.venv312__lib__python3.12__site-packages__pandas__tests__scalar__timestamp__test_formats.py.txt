# .venv312/lib/python3.12/site-packages/pandas/tests/scalar/timestamp/test_formats.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestTimestampRendering",
      "methods": [
        "test_repr",
        "test_repr_utcoffset",
        ...
        "test_repr_matches_pydatetime_tz_pytz",
        "test_repr_matches_pydatetime_tz_dateutil"
      ]
    }
  ],
  "functions": [
