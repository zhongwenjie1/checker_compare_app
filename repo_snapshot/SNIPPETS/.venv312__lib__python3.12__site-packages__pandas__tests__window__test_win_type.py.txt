# .venv312/lib/python3.12/site-packages/pandas/tests/window/test_win_type.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_win_type_freq_return_none",
...
def test_cmov_window_regular_linear_range(win_types, step):
    ...
    rs = Series(vals).rolling(5, win_type=win_types, c
```
