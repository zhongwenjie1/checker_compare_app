# .venv312/lib/python3.12/site-packages/pandas/tests/scalar/timestamp/methods/test_as_unit.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestTimestampAsUnit",
      "methods": [
        "test_as_unit",
        "test_as_unit_overflows",
        "test_as_unit_rounding",
        "test_as_unit_non_nano"
      ]
    }
  ],
  "functions": []
