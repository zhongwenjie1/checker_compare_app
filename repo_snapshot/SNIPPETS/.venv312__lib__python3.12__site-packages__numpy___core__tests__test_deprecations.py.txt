# .venv312/lib/python3.12/site-packages/numpy/_core/tests/test_deprecations.py

## Classes & Methods
{
  "classes": [
    {
      "name": "_DeprecationTestCase",
      "methods": [
        "setup_method",
        "teardown_method",
        "assert_deprecated",
    ...
    {
      "name": "_VisibleDeprecationTestCase",
      "methods": []
    },
    {
      "name": "TestTestDeprecated",
      "methods": [
    ...
    },
    {
      "name": "TestBincount",
      "methods": [
        "test_bincount_bad_list"
      ]
    },
    {
      "name": "TestGeneratorSum",
      "methods": [
        "test_generator_sum"
      ]
    },
    {
      "name": "BuiltInRoundComplexDType",
      "methods": [
        "test_deprecated",
        "test_not_deprecated"
      ]
    ...
    {
      "name": "FlatteningConcatenateUnsafeCast",
      "methods": [
        "test_deprecated",
        "test_not_deprecated"
      ]
    ...
    {
      "name": "TestQuantileInterpolationDeprecation",
      "methods": [
        "test_deprecated",
        "test_both_passed"
      ]
    ...
    {
      "name": "TestPyIntConversion",
      "methods": [
        "test_deprecated_scalar"
      ]
    },
    {
      "name": "TestRemovedGlobals",
      "methods": [
        "test_attributeerror_includes_info"
      ]
    },
    {
      "name": "TestDeprecatedFinfo",
      "methods": [
        "test_deprecated_none"
      ]
    },
    {
      "name": "TestMathAlias",
    ...
    },
    {
      "name": "TestLibImports",
      "methods": [
        "test_lib_functions_deprecation_call"
      ]
    },
    {
      "name": "TestDeprecatedDTypeAliases",
      "methods": [
        "_check_for_warning",
        "test_a_dtype_alias"
      ]
    ...
    {
      "name": "TestDeprecatedArrayWrap",
      "methods": [
        "test_deprecated"
      ]
    },
    {
      "name": "TestDeprecatedDTypeParenthesizedRepeatCount",
      "methods": [
        "test_parenthesized_repeat_count"
      ]
    },
    {
      "name": "TestDeprecatedSaveFixImports",
      "methods": [
        "test_deprecated"
      ]
    },
    {
      "name": "TestAddNewdocUFunc",
      "methods": [
        "test_deprecated"
      ]
    }
