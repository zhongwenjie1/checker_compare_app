# .venv312/lib/python3.12/site-packages/pandas/tests/io/formats/style/test_format.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_long_int_formatting",
    "test_format_options",
    "test_precision_zero",
    "test_formatter_options_validator",
    "test_formatter_options_raises",
    "test_1level_multiindex",
    "test_boolean_format",
    "test_relabel_raise_length",
    "test_relabel_index",
    "test_relabel_columns",
    "test_relabel_roundtrip"
  ]
}
