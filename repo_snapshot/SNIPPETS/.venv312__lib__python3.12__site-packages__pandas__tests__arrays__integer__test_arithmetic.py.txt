# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/integer/test_arithmetic.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_divide_by_zero",
    "test_floordiv",
    "test_floordiv_by_int_zero_no_mask",
    "test_mod",
    "test_pow_scalar",
    "test_pow_array",
    "test_rpow_one_to_na",
    ...
    "test_values_multiplying_large_series_by_NA",
    "test_bitwise"
  ]
}
