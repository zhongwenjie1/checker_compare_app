# .venv312/lib/python3.12/site-packages/pandas/tests/window/test_ewm.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_float_dtype_ewma",
    "test_times_string_col_raises",
    "test_ewm_sum_adjust_false_notimplemented",
    "test_ewm_sum",
    "test_ewma_adjust",
    "test_ewma_cases",
    ...
    "test_numeric_only_frame",
    "test_numeric_only_corr_cov_frame",
    "test_numeric_only_series",
    "test_numeric_only_corr_cov_series"
  ]
}
...
def test_ewma_nan_handling_cases(s, adjust, ignore_na, w):
    # GH 7603
    expected = (s.multiply(w).cumsum() / Series(w).cumsum(
```
