# .venv312/lib/python3.12/site-packages/pandas/tests/frame/methods/test_asfreq.py
  ...
  "classes": [
    {
      ...
      "methods": [
        "unit",
        "test_asfreq2",
        "test_asfreq_datetimeindex_empty",
        "test_tz_aware_asfreq_smoke",
        ...
        "test_asfreq_with_date_object_index",
        "test_asfreq_with_unsorted_index",
        "test_asfreq_after_normalize",
        "test_asfreq_2ME",
        "test_asfreq_frequency_M_Q_Y_A_deprecated"
      ]
    }
  ],
  "functions": []
