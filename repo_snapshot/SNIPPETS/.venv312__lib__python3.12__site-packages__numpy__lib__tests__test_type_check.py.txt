# .venv312/lib/python3.12/site-packages/numpy/lib/tests/test_type_check.py
...
class TestNanToNum:
    ...
    def test_array(self):
        vals = nan_to_num([1])
        assert_array_equal(vals, np.array([1]
```
