# .venv312/lib/python3.12/site-packages/pandas/tests/io/xml/test_xml.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_empty_attrs_only",
    "test_empty_elems_only",
    "test_attribute_centric_xml",
    "test_names_option_output",
    "test_repeat_names",
    "test_repeat_values_new_names",
    ...
    "test_wrong_encoding_for_lxml",
    "test_none_encoding_etree",
    ...
    "test_file_like_iterparse",
    "test_file_io_iterparse",
    "test_url_path_error",
    "test_compression_error",
    "test_wrong_dict_type",
    "test_wrong_dict_value",
    "test_bad_xml",
    "test_comment",
    "test_dtd",
