# .venv312/lib/python3.12/site-packages/pandas/tests/arrays/datetimes/test_constructors.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDatetimeArrayConstructor",
      "methods": [
        ...
        "test_mismatched_values_dtype_units",
        "test_freq_infer_raises",
        "test_copy",
        "test_numpy_datetime_unit"
      ]
    },
    {
      "name": "TestSequenceToDT64NS",
      "methods": [
  ...
  "functions": [
    "test_from_arrow_with_different_units_and_timezones_with",
    "test_from_arrow_from_empty",
    "test_from_arrow_from_integers"
  ]
}
