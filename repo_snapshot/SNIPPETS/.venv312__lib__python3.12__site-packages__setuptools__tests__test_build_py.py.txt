# .venv312/lib/python3.12/site-packages/setuptools/tests/test_build_py.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestTypeInfoFiles",
      "methods": [
        "test_type_files_included_by_default",
        "test_type_files_can_be_excluded",
        "test_stub_only_package"
      ]
    }
  ],
  "functions": [
    ...
    "test_excluded_subpackages",
    "test_existing_egg_info",
    "test_get_outputs",
    "get_finalized_build_py",
    "get_outputs"
  ]
}
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                marks=pytest.mark.xfail(reason="pypa/setuptools#4
```
