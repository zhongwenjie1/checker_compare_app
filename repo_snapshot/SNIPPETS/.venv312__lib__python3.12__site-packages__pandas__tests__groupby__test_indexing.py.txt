# .venv312/lib/python3.12/site-packages/pandas/tests/groupby/test_indexing.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "_make_df_from_data",
    "test_multiindex",
    "test_against_head_and_tail",
    "test_against_df_iloc",
    "test_series",
    "test_step",
    "column_group_df",
    "test_column_axis",
    "test_columns_on_iter",
    "test_groupby_duplicated_columns",
    "test_groupby_get_nonexisting_groups"
  ]
}
