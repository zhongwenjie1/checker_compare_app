# .venv312/lib/python3.12/site-packages/numpy/lib/tests/test__datasource.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataSourceOpen",
      "methods": [
        "setup_method",
        "teardown_method",
        "test_ValidHTTP",
