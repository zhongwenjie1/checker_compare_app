# .venv312/lib/python3.12/site-packages/pandas/tests/io/test_clipboard.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_infer_excel_with_nulls",
        "test_infer_excel_with_multiindex",
        "test_invalid_encoding",
        "test_raw_roundtrip",
        "test_read_clipboard_dtype_backend",
        "test_invalid_dtype_backend",
        "test_to_clipboard_pos_args_deprecation"
      ]
    }
  ],
  "functions": [
    ...
    "test_checked_call_with_valid_call",
    "test_stringify_text",
    "set_pyqt_clipboard",
    "clipboard"
  ]
