# .venv312/lib/python3.12/site-packages/setuptools/tests/config/test_expand.py
  ...
  "classes": [
    {
      "name": "TestReadAttr",
      "methods": [
        "test_read_attr_encoding_cookie",
        "test_read_attr",
        "test_read_annotated_attr",
