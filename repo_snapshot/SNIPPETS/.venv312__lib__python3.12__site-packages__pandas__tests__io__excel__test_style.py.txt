# .venv312/lib/python3.12/site-packages/pandas/tests/io/excel/test_style.py

## Classes & Methods
{
  "classes": [],
  "functions": [
    "assert_equal_cell_styles",
    "test_styler_to_excel_unstyled",
    "test_styler_to_excel_basic",
    "test_styler_to_excel_basic_indexes",
    "test_styler_to_excel_border_style",
    "test_styler_custom_converter",
    "test_styler_to_s3"
  ]
}
