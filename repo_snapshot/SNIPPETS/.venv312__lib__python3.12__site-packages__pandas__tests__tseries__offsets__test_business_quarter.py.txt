# .venv312/lib/python3.12/site-packages/pandas/tests/tseries/offsets/test_business_quarter.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestBQuarterBegin",
      "methods": [
        "test_repr",
        "test_is_anchored",
