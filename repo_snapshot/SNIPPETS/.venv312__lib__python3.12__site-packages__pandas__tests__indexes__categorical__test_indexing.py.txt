# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/categorical/test_indexing.py
...
class TestWhere:
    def test_where(self, listlike_box):
        ...
        expected = CategoricalIndex([np.nan] + i[1:].to
```
