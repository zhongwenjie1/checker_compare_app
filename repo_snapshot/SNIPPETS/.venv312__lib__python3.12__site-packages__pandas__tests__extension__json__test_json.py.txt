# .venv312/lib/python3.12/site-packages/pandas/tests/extension/json/test_json.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "na_cmp",
    "data_for_grouping",
    "custom_assert_series_equal",
    "custom_assert_frame_equal",
    "test_custom_asserts"
  ]
}
