# .venv312/lib/python3.12/site-packages/pandas/tests/frame/test_logical_ops.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDataFrameLogicalOperators",
      "methods": [
        ...
        "test_different_dtypes_different_index_raises"
      ]
    }
  ],
  "functions": []
