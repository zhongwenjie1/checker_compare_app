# .venv312/lib/python3.12/site-packages/pkg_resources/tests/test_pkg_resources.py
  ...
  "classes": [
    ...
    },
    {
      ...
      "methods": [
        ...
        "test_setuptools_not_imported"
      ]
    },
    {
      "name": "TestDeepVersionLookupDistutils",
      "methods": [
        "env",
        "create_foo_pkg",
    ...
    {
      "name": "TestWorkdirRequire",
      "methods": [
        "fake_site_packages",
        "test_require_non_normalised_name"
      ]
    }
  ],
  "functions": [
    ...
    "test_dist_info_is_not_dir",
    "test_macos_vers_fallback"
  ]
}
