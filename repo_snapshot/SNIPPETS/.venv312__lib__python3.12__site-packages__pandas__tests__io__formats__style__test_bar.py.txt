# .venv312/lib/python3.12/site-packages/pandas/tests/io/formats/style/test_bar.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "df_neg",
    "df_mix",
    "test_align_positive_cases",
    "test_align_negative_cases",
    "test_align_mixed_cases",
    "test_align_axis",
    "test_vmin_vmax_clipping",
    "test_vmin_vmax_widening",
    "test_numerics",
    "test_colors_mixed",
    "test_bar_align_height",
    "test_bar_value_error_raises",
    "test_bar_color_and_cmap_error_raises",
    "test_bar_invalid_color_type_error_raises",
    "test_styler_bar_with_NA_values",
...
def test_style_bar_with_pyarrow_NA_values():
    ...
    expected_substring = "style type="
    html_output = df.style.bar(subset="test1").to_htm
```
