# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/test_engines.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestDatetimeEngine",
      "methods": [
        "test_not_contains_requires_timestamp"
      ]
    },
    {
      "name": "TestTimedeltaEngine",
      "methods": [
        "test_not_contains_requires_timedelta"
      ]
    },
    {
      "name": "TestNumericEngine",
      "methods": [
        "test_is_monotonic",
        "test_is_unique",
        "test_get_loc"
