# .venv312/lib/python3.12/site-packages/pandas/tests/tseries/offsets/test_custom_business_hour.py

## Classes & Methods
{
  "classes": [
    {
      "name": "TestCustomBusinessHour",
      "methods": [
        ...
        "test_us_federal_holiday_with_datetime"
      ]
    }
  ],
  "functions": [
...
def test_custom_businesshour_weekmask_and_holiday
```
