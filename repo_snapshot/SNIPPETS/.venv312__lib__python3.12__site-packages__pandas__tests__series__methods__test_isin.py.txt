# .venv312/lib/python3.12/site-packages/pandas/tests/series/methods/test_isin.py
  ...
  "classes": [
    {
      ...
      "methods": [
        ...
        "test_isin_datetimelike_mismatched_reso",
        "test_isin_datetimelike_mismatched_reso_list",
        "test_isin_with_i8",
        "test_isin_empty",
        "test_isin_read_only",
        "test_isin_dt64_values_vs_ints",
        "test_isin_tzawareness_mismatch",
        "test_isin_period_freq_mismatch",
        "test_isin_float_in_int_series",
        "test_isin_masked_types"
      ]
    }
  ],
  "functions": [
    "test_isin_large_series_mixed_dtypes_and_nan",
    "test_isin_complex_numbers",
    "test_isin_filtering_with_mixed_object_types",
    "test_isin_filtering_on_iterable"
  ]
}
