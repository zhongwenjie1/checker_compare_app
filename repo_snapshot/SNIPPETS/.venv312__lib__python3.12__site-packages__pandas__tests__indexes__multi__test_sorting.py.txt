# .venv312/lib/python3.12/site-packages/pandas/tests/indexes/multi/test_sorting.py
...
## Classes & Methods
{
  ...
  "functions": [
    ...
    "test_sort_values_incomparable",
    "test_sort_values_with_na_na_position",
    "test_sort_unnecessary_warning"
  ]
}
